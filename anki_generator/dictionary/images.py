...
from anki_generator.inputs.english import extract_pos_tags, strip_pos_labels_from_term
from anki_generator.utils import retry_call
from anki_generator.dictionary.cambridge import fetch_cambridge_image_url
